          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-300">
                ...
                <GlassInputWrapper>
                  <input name="email" type="text" placeholder="Entrez votre adresse e-mail" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none text-white placeholder:text-white/50" />
                </GlassInputWrapper>
              </div>
